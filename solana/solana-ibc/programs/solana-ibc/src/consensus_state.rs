...
use ibc::{clients::ics07_tendermint::consensus_state::ConsensusState as TmConsensusState, mock::consensus_state::MockConsensusState};
    ...
    > {
        match self {
            ...
            AnyConsensusState::Mock(_) => Err(ClientError::Other {
                description: "Cannot convert mock consensus state to tendermint".to_string(),
            }),
        }
    }
}
    ...
    for AnyConsensusState
{
    ...
    fn try_into(
        ...
        ibc::mock::consensus_state::MockConsensusState,
        Self::Error,
    > {
        match self {
            AnyConsensusState::Mock(value) => Ok(value),
            AnyConsensusState::Tendermint(_) => Err(ClientError::Other {
                description: "Cannot convert tendermint consensus state to mock".to_string(),
            }),
        }
    }
}