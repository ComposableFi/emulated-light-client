...
fn test_encode() {
    ...
    test(&[0, 8, 0x80], U3::_0, 1, &[0x80]);
    test(&[0, 8, 0x80], U3::_0, 1, &[0xFF]);
    test(&[0, 8 + 4, 0x08], U3::_4, 1, &[0xFF]);
    test(&[0, 9 * 8, 0xFF, 0x80], U3::_0, 9, &[0xFF, 0xFF]);
    test(&[0, 9 * 8 + 4, 0x0F, 0xF8], U3::_4, 9, &[0xFF, 0xFF]);
    test(&[0, 17 * 8, 0xFF, 0xFF, 0x80], U3::_0, 17, &[0xFF, 0xFF, 0xFF]);
